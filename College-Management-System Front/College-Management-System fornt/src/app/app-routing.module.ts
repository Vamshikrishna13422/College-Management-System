...
import { FacualtyForgotPasswordComponent } from './facualty-forgot-password/facualty-forgot-password.component';
...
const routes: Routes = [
  ...
  {path:'facualty-forgot-password',component:FacualtyForgotPasswordComponent},
  {path:'student-forgot-password',component:StudentForgotPasswordComponent}
